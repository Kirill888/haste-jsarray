...
newtype ArrayBuffer = ArrayBuffer JSAny deriving (FromAny, ToAny)
...
class (FromAny a, ToAny a)=>TypedArray a where
  type EltType a
  newSizedArray::Int->IO a
  copyTypedArray::TypedArray b=>b->a
  fromList::ToAny (EltType a)=>[EltType a]->a
  ...
  getIndex::FromAny (EltType a)=>a->Int->IO (EltType a)
  getIndex = ffi "(function(arr, idx) {return arr[idx];})"
  setIndex::ToAny (EltType a)=>a->Int->EltType a->IO ()
  setIndex = ffi "(function(arr, idx, val) {arr[idx] = val;})"
  toList::(FromAny (EltType a), NFData (EltType a))=>a->[EltType a]
...
newtype Int8Array = Int8Array JSAny deriving (FromAny, ToAny)
...
newtype Int16Array = Int16Array JSAny deriving (FromAny, ToAny)
...
newtype Int32Array = Int32Array JSAny deriving (FromAny, ToAny)
...
newtype Int64Array = Int64Array JSAny deriving (FromAny, ToAny)
...
newtype Uint8Array = Uint8Array JSAny deriving (FromAny, ToAny)
...
newtype Uint16Array = Uint16Array JSAny deriving (FromAny, ToAny)
...
newtype Uint32Array = Uint32Array JSAny deriving (FromAny, ToAny)
...
newtype Float32Array = Float32Array JSAny deriving (FromAny, ToAny)
